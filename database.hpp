...
class Database {
  ...
  void addExperienceByBestApp(std::string userId, std::string companyId, std::string title, std::string startAt , std::string endsAt = NOW);
